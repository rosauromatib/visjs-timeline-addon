...
//  private void addGroupIDToItmes() {
////    this.items.stream().map(item -> {
////      this.groupItems.stream().map(groupItem -> {
////        if(groupItem.getNestedGroups() != null){
////          String[] groupIdArray = groupItem.getNestedGroups().split(",");
////          for (int i = 0; i < groupIdArray.length; i++){
////            if(Integer.parseInt(groupIdArray[i]) == Integer.parseInt(item.getId())){
////              item.setGroupID(groupIdArray[i]);
////            }
////          }
////        }
////        return null;
...
//      }
//    }
////      item.setGroupID(String.valueOf(2));
////    });
//  }
...
//  }
    ...
    /**
     * Adds a listener for {@link GroupItemSelectEvent} to the component.
     *
     * @param listener the listener to be added
     */
